...
export default defineConfig([
  globalIgnores([
    ...
    'src/types.gen.ts',
    // Auto-generated by the src/schema codegen (pixi run sync).
    'src/utils/formFields.ts',
    'src/components/dataOrganization/schema/schemaData.ts',
    // Hand-mirrored registry kept one-field-per-line for the Python drift test
    // (tests/catalog/test_filter_fields_drift.py); reformatting breaks its parser.
    'src/utils/filterFields.ts',
    'tests/*',
    '**/__tests__',
    '**/*.test.{ts,tsx}',
    '.pixi/*',
