  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        fields: [
        { field: 'tomogram_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Processing folder name, e.g. bp_3dctf_bin4; the TOML id must match the folder.' },
        ...
        { field: 'tilt_series_id', type: 'text', source: 'acquisition.toml [raw_tomogram]', kind: 'authored', notes: 'Tilt series (in this acquisition) this reconstruction was built from; cross-referenced against the acquisition\'s tilt series ids.' },
        { field: 'pipeline', type: 'text', source: 'acquisition.toml [raw_tomogram]', kind: 'authored', notes: 'Human description.' },
        { field: 'software', type: 'text', source: 'acquisition.toml [raw_tomogram]', kind: 'authored', notes: '' },
        { field: 'voxel_size', type: 'float', source: 'MRC header', kind: 'derived', notes: 'Ångström/pixel. Populated by the catalog scanner from the reconstruction MRC header\'s voxel_size.x; not authored in any TOML.' },
        { field: 'derived_from', type: 'list[text]', source: 'acquisition.toml [raw_tomogram]', kind: 'authored', notes: 'Lineage; empty for raw reconstructions.' },
        ...
        { field: 'renamed_from', type: 'text', source: 'acquisition.toml [raw_tomogram]', kind: 'authored', notes: 'Scan-time-only rename directive; not stored in the DB.' },
        ],
      },
      {
        ...
        fields: [
        { field: 'tomogram_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Processing folder name; the TOML id must match the folder.' },
        { field: 'acquisition_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Parent acquisition folder name.' },
        { field: 'sample_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Parent sample folder name.' },
        { field: 'tilt_series_id', type: 'text', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: 'Tilt series (in this acquisition) this reconstruction was built from; cross-referenced against the acquisition\'s tilt series ids.' },
        { field: 'denoising_software', type: 'text', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: '' },
        { field: 'ctf_software', type: 'text', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: '' },
        { field: 'missing_wedge_software', type: 'text', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: '' },
        { field: 'voxel_size', type: 'float', source: 'MRC header', kind: 'derived', notes: 'Ångström/pixel. Populated by the catalog scanner from the reconstruction MRC header\'s voxel_size.x; not authored in any TOML.' },
        { field: 'derived_from', type: 'list[text]', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: 'Lineage; references a raw or post-processed tomogram_id in this acquisition.' },
        { field: 'image_size_x', type: 'integer', source: 'MRC header', kind: 'derived', notes: '' },
        { field: 'image_size_y', type: 'integer', source: 'MRC header', kind: 'derived', notes: '' },
        { field: 'image_size_z', type: 'integer', source: 'MRC header', kind: 'derived', notes: '' },
        { field: 'mrc_path', type: 'text', source: 'directory', kind: 'derived', notes: 'Derived from prescribed layout.' },
        ...
        { field: 'renamed_from', type: 'text', source: 'acquisition.toml [[post_processed_tomogram]]', kind: 'authored', notes: 'Scan-time-only rename directive; not stored in the DB.' },
        ],
      },
      {
        ...
        cardinality: '0..N per acquisition',
        fields: [
        { field: 'annotation_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Annotation folder name, e.g. membrain_seg_v10; the TOML id must match the folder.' },
        { field: 'acquisition_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Parent acquisition folder name.' },
        { field: 'sample_id', type: 'text', source: 'directory', kind: 'derived', notes: 'Parent sample folder name.' },
        { field: 'type', type: 'text', source: 'acquisition.toml [[annotation]]', kind: 'authored', notes: 'e.g. membrane_segmentation, nucleosome_placement, nucleosome_orientation, sta_result.' },
        { field: 'target_tomogram', type: 'text', source: 'acquisition.toml [[annotation]]', kind: 'authored', notes: 'Tomogram this was generated from.' },
        { field: 'files', type: 'list[text]', source: 'directory', kind: 'derived', notes: '.star, .mrc, .ome.zarr, .png artifacts discovered in the folder.' },
        { field: 'renamed_from', type: 'text', source: 'acquisition.toml [[annotation]]', kind: 'authored', notes: 'Scan-time-only rename directive; not stored in the DB.' },
        ],
      },
      {
