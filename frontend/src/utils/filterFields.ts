...
export const GROUPS: Group[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'linker_length_bp',
        label: 'Linker length (bp)',
        entity: 'sample',
        group: 'chromatin',
        kind: 'range',
        table: 'chromatin',
        column: 'linker_length_bp'
      },
      // ponytail: data-derived categorical (stored list[int] stringified, matched IN verbatim); upgrade to json_each only if needed.
      {
        ...
        kind: 'text',
        table: 'chromatin',
        column: 'linker_pattern'
      },
      {
        key: 'linker_distribution',
        label: 'Linker distribution',
        entity: 'sample',
        group: 'chromatin',
        kind: 'text',
        table: 'chromatin',
        column: 'linker_distribution'
      },
      {
        key: 'buffer',
        label: 'Buffer',
      ...
      {
        key: 'histone_variants',
        label: 'Histone variants',
        entity: 'sample',
        group: 'chromatin',
        kind: 'text',
        table: 'chromatin',
        column: 'histone_variants'
      },
      {
        key: 'transcription_factors',
        label: 'Transcription factors',
        entity: 'sample',
        group: 'chromatin',
        kind: 'text',
        table: 'chromatin',
        column: 'transcription_factors'
      },
      {
        key: 'nucleosome_count',
        label: 'Nucleosome count',
        entity: 'sample',
        group: 'chromatin',
        kind: 'range',
        table: 'chromatin',
        column: 'nucleosome_count'
      },
      {
        key: 'dna_length_bp',
        label: 'DNA length (bp)',
      ...
      },
      {
        ...
        kind: 'range',
        table: 'chromatin',
        column: 'nucleosome_uM'
      },
      {
        key: 'sequence_identity',
        label: 'Sequence identity',
        entity: 'sample',
        group: 'chromatin',
        kind: 'text',
        table: 'chromatin',
        column: 'sequence_identity'
      },
      // ponytail: data-derived categorical (stored list[int] stringified, matched IN verbatim).
      {
        key: 'nucleosome_footprint',
        label: 'Nucleosome footprint',
        entity: 'sample',
        group: 'chromatin',
        kind: 'text',
        table: 'chromatin',
        column: 'nucleosome_footprint'
      },
      {
        key: 'linker_length_fraction',
        label: 'Linker length fraction',
        entity: 'sample',
        group: 'chromatin',
        kind: 'range',
        table: 'chromatin',
        column: 'linker_length_fraction'
      }
    ]
  },
  {
    ...
    fields: [
      ...
      {
        key: 'conjugation_target',
        label: 'Conjugation target',
        entity: 'sample',
        group: 'labels',
        kind: 'text',
        table: 'labels',
        column: 'conjugation_target'
      },
      {
        key: 'fluorophore',
        label: 'Fluorophore',
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'planchette_size',
        label: 'Planchette size',
        entity: 'sample',
        group: 'freezing',
        kind: 'text',
        table: 'freezing',
        column: 'planchette_size'
      },
      {
        key: 'spacer_thickness',
        label: 'Spacer thickness',
        entity: 'sample',
        group: 'freezing',
        kind: 'text',
        table: 'freezing',
        column: 'spacer_thickness'
      }
    ]
  },
  {
  ...
  // ---- Section B — Acquisition properties -------------------------------
  {
    ...
    fields: [
      ...
      {
        key: 'acquisition_quality',
        label: 'Acquisition quality',
        entity: 'acquisition',
        group: 'general',
        kind: 'text',
        table: 'acquisitions',
        column: 'acquisition_quality'
      },
      {
        key: 'pixel_size',
        label: 'Pixel size',
      ...
      {
        key: 'energy_filter_slit_width',
        label: 'Energy filter slit width',
        entity: 'acquisition',
        group: 'general',
        kind: 'range',
        table: 'acquisitions',
        column: 'energy_filter_slit_width'
      },
      {
        key: 'frame_count',
        label: 'Frame count',
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'has_unaligned_tilt_series',
        label: 'Has unaligned tilt series',
        entity: 'acquisition',
        group: 'tilt_series',
        kind: 'existence',
        table: 'tilt_series',
        column: 'has_unaligned_tilt_series'
      },
      // has_aligned_tilt_series -> tilt_series WHERE is_aligned IS TRUE
      {
        key: 'has_aligned_tilt_series',
        label: 'Has aligned tilt series',
        entity: 'acquisition',
        group: 'tilt_series',
        kind: 'existence',
        table: 'tilt_series',
        column: 'has_aligned_tilt_series'
      },
      // has_tilt_series_zarr -> tilt_series WHERE zarr_path IS NOT NULL
      {
        key: 'has_tilt_series_zarr',
        label: 'Has tilt series Zarr',
        entity: 'acquisition',
        group: 'tilt_series',
        kind: 'existence',
        table: 'tilt_series',
        column: 'has_tilt_series_zarr'
      }
    ]
  },
  {
    ...
    fields: [
      ...
      {
        key: 'has_raw_tomogram',
        label: 'Has raw tomogram',
        entity: 'acquisition',
        group: 'tomograms',
        kind: 'existence',
        table: 'raw_tomograms',
        column: 'has_raw_tomogram'
      },
      // has_post_processed_tomogram -> post_processed_tomograms exists
      {
        key: 'has_post_processed_tomogram',
        label: 'Has post-processed tomogram',
        entity: 'acquisition',
        group: 'tomograms',
        kind: 'existence',
        table: 'post_processed_tomograms',
        column: 'has_post_processed_tomogram'
      },
      // has_tomogram_zarr -> (raw UNION post) WHERE zarr_path IS NOT NULL; nominal table raw_tomograms, Phase 1 ORs both.
      {
        key: 'has_tomogram_zarr',
        label: 'Has tomogram Zarr',
        entity: 'acquisition',
        group: 'tomograms',
        kind: 'existence',
        table: 'raw_tomograms',
        column: 'has_tomogram_zarr'
      }
    ]
  },
  {
