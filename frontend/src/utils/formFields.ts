...
export const FORM_SECTIONS: FormSection[] = [
  {
    ...
    repeatable: false,
    root: true,
    requiresDataSource: null,
    requiresProject: null,
    crossRefLiterals: [],
    idNamespace: null,
    immutableOnLoad: false
  },
  {
    form: 'acquisition',
    section: 'acquisition',
  ...
  },
  {
    form: 'acquisition',
    section: 'md_source',
    title: 'MD source (simulation)',
    repeatable: false,
    root: false,
    requiresDataSource: 'simulation',
    requiresProject: null,
    crossRefLiterals: [],
    idNamespace: null,
    immutableOnLoad: false
  },
  {
    ...
    requiresDataSource: null,
    requiresProject: null,
    crossRefLiterals: ['Frames'],
    idNamespace: 'tilt_series',
    immutableOnLoad: true
  },
  {
    form: 'acquisition',
    section: 'reconstruction_alignment',
    title: '3D alignment',
    repeatable: true,
    root: false,
    requiresDataSource: null,
    requiresProject: null,
    crossRefLiterals: [],
    idNamespace: 'reconstruction_alignment',
    immutableOnLoad: true
  },
  {
    form: 'acquisition',
    section: 'raw_tomogram',
    title: 'Raw tomograms',
    repeatable: true,
    root: false,
    requiresDataSource: null,
    requiresProject: null,
    crossRefLiterals: [],
    idNamespace: 'tomogram',
    immutableOnLoad: true
  },
  {
    form: 'acquisition',
    section: 'post_processed_tomogram',
    title: 'Post-processed tomograms',
    repeatable: true,
    root: false,
    requiresDataSource: null,
    requiresProject: null,
  ...
  },
  {
    form: 'sample',
    section: 'label',
    title: 'Gold-nanoparticle labels',
    repeatable: true,
    root: false,
    requiresDataSource: 'experimental',
    requiresProject: null,
    crossRefLiterals: [],
    idNamespace: null,
    immutableOnLoad: false
...
export const FORM_FIELDS: FormField[] = [
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous acquisition id if you renamed this directory, so the scanner records a rename instead of a deletion + new acquisition.'
  },
  {
    form: 'acquisition',
    section: 'acquisition',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Target tilt step in degrees, e.g. 3.0 (intent; actual angles come from the MDOC).'
  },
  {
    form: 'acquisition',
    section: 'acquisition',
    field: 'defocus_range',
    label: 'Defocus range (µm)',
    input: 'text',
    required: false,
    isId: false,
    derived: false,
    ...
    options: [],
    alias: null,
    help: 'Target defocus range in µm, e.g. "-1.5 to -3.0" (intent; per-image actuals come from the MDOC).'
  },
  {
    form: 'acquisition',
    section: 'acquisition',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: "MUST match a MdRuns/{id}/ folder name (the md_run.toml id). Suggested from the sample's runs; free text also accepted."
  },
  {
    form: 'acquisition',
    section: 'md_source',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous tilt series id if you renamed this directory, so the scanner records a rename instead of a deletion + new tilt series.'
  },
  {
    form: 'acquisition',
    section: 'tilt_series',
  ...
  },
  {
    ...
    options: [],
    alias: 'id',
    help: 'MUST equal the folder name under Reconstructions/. Does NOT have to match any tilt series id.'
  },
  {
    form: 'acquisition',
    section: 'reconstruction_alignment',
    ...
    options: [],
    alias: null,
    help: 'Previous 3D alignment id if you renamed this directory, so the scanner records a rename instead of a deletion + new group.'
  },
  {
    form: 'acquisition',
    section: 'reconstruction_alignment',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous tomogram id if you renamed this directory, so the scanner records a rename instead of a deletion + new tomogram.'
  },
  {
    form: 'acquisition',
    section: 'raw_tomogram',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Id of the single tomogram, or ids of the multiple tomograms, in this acquisition this was derived from.'
  },
  {
    form: 'acquisition',
    section: 'annotation',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous annotation id if you renamed this directory, so the scanner records a rename instead of a deletion + new annotation.'
  },
  {
    form: 'acquisition',
    section: 'annotation',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Id of the annotation file (under Annotations/) holding the bounding box this annotation is associated with.'
  },
  {
    form: 'sample',
    section: 'sample',
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous sample id if you renamed this directory, so the scanner records a rename instead of a deletion + new sample.'
  },
  {
    form: 'sample',
    section: 'sample',
  ...
  },
  {
    ...
    crossRef: null,
    apiSuggest: null,
    options: ['chromatin', 'synapse', 'nanogold'],
    alias: null,
  ...
  },
  {
    ...
    crossRef: null,
    apiSuggest: null,
    options: ['collepardo', 'gouaux', 'rosen', 'villa'],
    alias: null,
  ...
  },
  {
    ...
    options: [],
    alias: null,
    help: 'Previous tomogram id if you renamed this file, so the scanner records a rename instead of a deletion + new tomogram.'
  },
  {
    form: 'reconstruction',
    section: 'raw_tomogram',
  ...
  },
  {
    ...
    options: [],
    alias: 'id',
    help: 'MUST equal the annotation file\'s name without extension, e.g. "membrain_seg_v10".'
  },
  {
    form: 'reconstruction',
    section: 'annotation',
    ...
    options: [],
    alias: null,
    help: 'Previous annotation id if you renamed this file, so the scanner records a rename instead of a deletion + new annotation.'
  },
  {
    form: 'reconstruction',
    section: 'annotation',
